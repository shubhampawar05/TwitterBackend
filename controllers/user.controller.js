...
const userConrtoller = {
  profile: catchAsync(profile),
  followOrUnfollow: catchAsync(followOrUnfollow),
  getSuggestedUsers: catchAsync(getSuggestedUsers),
  updateUser:catchAsync(updateUser),
};

export default userConrtoller;
